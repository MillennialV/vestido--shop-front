...
const SiteFooter: React.FC = () => {
    ...
    const whatsappNumber = storeInfo?.whatsapp || "+51 956 382 746";
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-[40px] mb-[60px]">
                    ...
                    <div className="flex flex-col sm:items-start sm:text-left">
                        ...
                        <div className="flex gap-[16px] mt-[24px]">
                            <Link href={facebookUrl} target="_blank" rel="noopener noreferrer" className="hover:underline"><FacebookIcon className="size-[24px]" /></Link>
                            <Link href={instagramUrl} target="_blank" rel="noopener noreferrer" className="hover:underline"><InstagramIcon className="size-[24px]" /></Link>
                            <Link href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="hover:underline"><WhatsappIcon className="size-[24px]" /></Link>
                        </div>
                    </div>
