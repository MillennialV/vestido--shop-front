...
export const WhatsappIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      fill="currentColor"
      d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.8 0-67.6-9.5-97.2-26.7l-7-4.1-72.5 19.1 19.4-70.5-4.5-7.3c-18.4-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"
    />
  </svg>
);
...
export const QrCodeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M3 3h8v8H3V3zm2 2v4h4V5H5zm8-2h8v8h-8V3zm2 2v4h4V5h-4zM3 13h8v8H3v-8zm2 2v4h4v-4H5zm13-2h3v3h-3v-3zm0 5h3v3h-3v-3zm-3-5h3v3h-3v-3zm0 5h3v3h-3v-3z" />
  </svg>
);
...
export const SunIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <circle cx="12" cy="12" r="4" stroke="currentColor" fill="none"></circle>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const GripVerticalIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const ExcelIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M14.7,2.3H6.3C5.2,2.3,4.3,3.2,4.3,4.3v15.4c0,1.1,0.9,1.9,1.9,1.9l11.5,0c1.1,0,1.9-0.9,1.9-1.9V7L14.7,2.3z M16.3,19.7H6.3V4.3h7.7v3.5h3.5L16.3,19.7z" />
    <path d="M14.5,14L14.5,14L13,11.5l1.4-2.4H13l-0.8,1.5l-0.8-1.5h-1.5l1.4,2.4l-1.5,2.5h1.5l0.8-1.5l0.8,1.5H14.5z" />
  </svg>
);
...
export const TruckIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.129-1.125V11.25c0-.447-.406-.813-.853-.813h-3.105a1.125 1.125 0 0 1-1.125-1.125V3.375C16.125 2.615 15.51 2 14.75 2H4.875A1.125 1.125 0 0 0 3.75 3.125V14.25m17.25 0h-5.625c-.621 0-1.125-.504-1.125-1.125V3.375a1.125 1.125 0 0 1 1.125-1.125h3.105c.447 0 .853.366.853.813v7.112c.447 0 .853.366.853.813v3.125c0 .447-.406.813-.853.813Z"
    />
  </svg>
);
