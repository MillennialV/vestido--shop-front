...
const Header: React.FC<HeaderProps> = ({ isAdmin, onToggleAdmin, navigate }) => {
    ...
    <header className="py-4 border-b border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center pt-4 pb-2">
          <a href="/" onClick={(e) => handleLinkClick(e, '/')} className="text-stone-900 dark:text-stone-100 hover:text-stone-700 dark:hover:text-stone-300 transition-colors">
            <h1 className="text-3xl md:text-4xl font-semibold tracking-wider">Vestidos de Fiesta</h1>
            <p className="mt-1 text-base text-stone-500 dark:text-stone-400 tracking-widest uppercase">by Womanity</p>
          </a>
        </div>
      </div>
    </header>
